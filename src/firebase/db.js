...
// ── Accounts (stored on household doc) ─────────────────

export async function saveHouseholdAccounts(householdId, accounts) {
  await setDoc(doc(db, 'households', householdId), { accounts }, { merge: true });
}
