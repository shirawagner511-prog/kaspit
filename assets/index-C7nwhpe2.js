const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Dashboard-duMjM8CR.js","assets/i18n-DHnzMtDv.js","assets/EntryItem-7BsXeZtH.js","assets/format-DKCwpWCP.js","assets/CategoryIcon-CrhuBF5E.js","assets/trash-2-DWq7E2y7.js","assets/react-vendor-ByMXOXG8.js","assets/firebase-MQBIVSCz.js","assets/Entries-BFEa7P55.js","assets/Breakeven-Bnhgj1bj.js","assets/PremiumGate-EVDBLG8w.js","assets/Insights-Kmkuj95c.js","assets/Settings-DbvvraJ5.js","assets/ImportCSV-D6-EWSvj.js","assets/Accounts-BQJFQvZe.js","assets/BudgiBot-4tCuf9gA.js"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Aa(e,t){const n=await Je(e),a=Qt(t),s={method:"POST",headers:n,body:JSON.stringify(a)};let r;try{r=await(await fetch(Ye(e.appConfig),s)).json()}catch(c){throw R.create("token-subscribe-failed",{errorInfo:c==null?void 0:c.toString()})}if(r.error){const c=r.error.message;throw R.create("token-subscribe-failed",{errorInfo:c})}if(!r.token)throw R.create("token-subscribe-no-token");return r.token}async function Ta(e,t){const n=await Je(e),a=Qt(t.subscriptionOptions),s={method:"PATCH",headers:n,body:JSON.stringify(a)};let r;try{r=await(await fetch(`${Ye(e.appConfig)}/${t.token}`,s)).json()}catch(c){throw R.create("token-update-failed",{errorInfo:c==null?void 0:c.toString()})}if(r.error){const c=r.error.message;throw R.create("token-update-failed",{errorInfo:c})}if(!r.token)throw R.create("token-update-no-token");return r.token}async function Da(e,t){const a={method:"DELETE",headers:await Je(e)};try{const r=await(await fetch(`${Ye(e.appConfig)}/${t}`,a)).json();if(r.error){const c=r.error.message;throw R.create("token-unsubscribe-failed",{errorInfo:c})}}catch(s){throw R.create("token-unsubscribe-failed",{errorInfo:s==null?void 0:s.toString()})}}function Ye({projectId:e}){return`${ya}/projects/${e}/registrations`}async function Je({appConfig:e,installations:t}){const n=await t.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e.apiKey,"x-goog-firebase-installations-auth":`FIS ${n}`})}function Qt({p256dh:e,auth:t,endpoint:n,vapidKey:a}){const s={web:{endpoint:n,auth:t,p256dh:e}};return a!==Yt&&(s.web.applicationPubKey=a),s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wa(e){if(!e||!e.options)throw _e("App Configuration Object");if(!e.name)throw _e("App Name");const t=["projectId","apiKey","appId","messagingSenderId"],{options:n}=e;for(const a of t)if(!n[a])throw _e(a);return{appName:e.name,projectId:n.projectId,apiKey:n.apiKey,appId:n.appId,senderId:n.messagingSenderId}}function _e(e){return R.create("missing-app-config-values",{valueName:e})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ha(e){try{e.swRegistration=await navigator.serviceWorker.register(ga,{scope:fa}),e.swRegistration.update().catch(()=>{})}catch(t){throw R.create("failed-service-worker-registration",{browserErrorMessage:t==null?void 0:t.message})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function za(e,t){if(!t&&!e.swRegistration&&await Ha(e),!(!t&&e.swRegistration)){if(!(t instanceof ServiceWorkerRegistration))throw R.create("invalid-sw-registration");e.swRegistration=t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function en(e,t){if(!navigator)throw R.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw R.create("permission-blocked");return await Ka(e,t==null?void 0:t.vapidKey),await za(e,t==null?void 0:t.serviceWorkerRegistration),_a(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
